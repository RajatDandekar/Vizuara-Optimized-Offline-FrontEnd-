...
impl Event_Constants{
    ...
    pub const fn GET_SELECTION_UPDATED(&self) -> &str{
        "SelectionUpdated"
    }

    pub const fn FILE_START_DOWNLOAD(&self) -> &str{
        "FileStartDownload"
    }

    pub const fn FILE_BEING_DOWNLOADED(&self) -> &str{
        "FileBeingDownloaded"
    }

    pub const fn FILE_END_DOWNLOAD(&self) -> &str{
        "FileEndDownload"
    }
}
